...
dictionary-test.o: vector.h dictionary.cpp dictionary-test.h dictionary-test.cpp
	g++ -c dictionary-test.cpp -o dictionary-test.o -I -Wall

dictionary-main.o: vector.h dictionary.cpp dictionary-test.h dictionary-main.cpp
